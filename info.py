...
API_ID = int(environ.get('API_ID', '3907247'))
API_HASH = environ.get('API_HASH', '77b6b1af31b8a1781cfc23ff8272e33f')
BOT_TOKEN = environ.get('BOT_TOKEN', "7313233043:AAGDAwPi5b98QouE1_E4QG-7c0czbFAHitE")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002187871490'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5669934860').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002089297740').split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'mighty_007') # owner username without @
